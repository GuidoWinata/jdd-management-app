...
export const staticSections: EventSection[] = [
  ...
  },
  {
    ...
    title: 'Tentang JDD',
    description: '<p>Jatim Developer Day adalah konferensi developer terbesar di Jawa Timur.</p>',
    image_path: null,
    settings_json: null,
    sort_order: 2,
    is_active: true,
  ...
  },
  {
    ...
    description: '<p>Jl. Basuki Rahmat No.100, Surabaya</p>',
    image_path: null,
    settings_json: null,
    sort_order: 3,
    is_active: true,
