...
@section('content')
    <div class="w-full max-w-md">
        <div class="mb-6 flex justify-center">
            <img src="{{ asset('images/jdd-logo.png') }}" alt="Logo" class="w-auto h-15">
        </div>
        <div class="bg-white shadow-2xl dark:bg-neutral-900 dark:border-neutral-700 rounded-2xl p-6 ">
            ...
            <form id="login-form" action="{{ route('login.post') }}" method="POST">
                ...
                <div class="grid gap-y-4">
                    ...
                    <!-- Form Group -->
                    <div>
                        <label for="email" class="block text-sm mb-2 dark:text-white">Email / Username</label>
                        <div class="relative">
